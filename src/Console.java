...
userChoice = scanner.nextLine();
    switch (userChoice){
        ...
        case "1":
            ...
            Produkte product = controller.produktenRepo.readById(id);
        ...
        case "2":
            ...
            Produkte newProduct = new Produkte(productID, productName, productPrice, universe);
        ...
        case "3":
            ...
            Produkte updatedProduct = new Produkte(productIDToUpdate, newProductName, newProductPrice, newProductHerkunftsregion);
        ...
        case "6":
            ...
            scanner.nextLine(); // Consume newline
            Charaktere character = controller.charakterenRepo.readById(id1);
            ...
            case "7":
                ...
                List<Produkte> associatedProducts = new ArrayList<>();
                ...
                if (!productIDsInput.equals("0")) {
                    ...
                    for (String productID7 : productIDs) {
                        ...
                        Produkte product7 = controller.produktenRepo.readById(id7); // Fetch product
                        if (product7 != null) {
                ...
                Charaktere newCharacter = new Charaktere(characterID, characterName, characterRegion, associatedProducts);
                ...
                case "8":
                    ...
                    List<Produkte> associatedProducts2 = new ArrayList<>();
                    ...
                    Charaktere newCharacter2 = new Charaktere(characterID2, characterName2, characterRegion2, associatedProducts2);
                    controller.charakterenRepo.update(newCharacter2);
                    System.out.println("Character updated: " + newCharacter2);
                    break;
        case "9":
            System.out.println("Enter character ID:");
            int characterID3 = scanner.nextInt();
            scanner.nextLine(); // Consume newline
            Charaktere character1 = controller.charakterenRepo.readById(characterID3);
